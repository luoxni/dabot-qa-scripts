...
def write_csv(response_J,response_time,runcount):
    ...
    field_names = ['runcount','targetInfo', 'sourceInfo', 'mappings', 'coloum','datatype','potentialMatch','Sourcereference', 'confidence','potentialMatch_datatype', 'matchtype','respond_time']
    row_values = []
